...
import { TemplateDrivenFormsLearningComponent } from './components/template-driven-forms-learning/template-driven-forms-learning.component';
...
@NgModule({
  declarations: [
    ...
    TemplateDrivenFormsLearningComponent
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
